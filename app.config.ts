export default defineAppConfig({
    ...
    ui: {
        container: {
            constrained: 'mx-auto max-w-screen-lg px-3 py-10 md:py-24 lg:py-28',
        },
        button: {
            color: {
                pink: {
                    solid: 'uppercase bg-pink text-white hover:bg-opacity-70 rounded-full inline-block transition-colors only:sm:text-sm px-4 py-2 md:px-7 md:py-2 tracking-widest font-bold disabled:pointer-event-none',
