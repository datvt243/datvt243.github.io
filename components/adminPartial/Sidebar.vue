...
<template>
	...
	>
		<!-- SIDEBAR HEADER -->
		<div class="clearfix">
			<p class="text-center py-3 uppercase text-2xl">
					...
					<ul class="mb-6 flex flex-col gap-1.5">
						...
						<li>
							<a
								...
								:class="{
									'bg-graydark dark:bg-meta-4': selected === 'Calendar' && page === 'calendar',
								}"
							>
								<svg
									class="fill-current"
						...
						<li>
							<a
								...
								:class="{
									'bg-graydark dark:bg-meta-4':
										selected === 'Forms' || page === 'formElements' || page === 'formLayout',
								}"
							>
								<svg
									class="fill-current"
					...
					<ul class="mb-6 flex flex-col gap-1.5">
						...
						<li>
							<a
								...
								:class="{
									'bg-graydark dark:bg-meta-4':
										selected === 'UiElements' || page === 'alerts' || page === 'buttons',
								}"
							>
								<svg
									class="fill-current"
						...
						<li>
							<a
								...
								:class="{
									'bg-graydark dark:bg-meta-4':
										selected === 'AuthPages' || page === 'register' || page === 'login',
								}"
							>
								<svg
									class="fill-current"
